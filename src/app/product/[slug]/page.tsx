...
const productData = {
  id: 'p1',
  title: 'The Royal Anniversary Box',
  price: 4999,
  rating: 4.8,
  reviews: 124,
  description: 'A luxurious assortment of premium chocolates, handcrafted soy candles, artisanal teas, and a personalized message card. Packaged in a velvet-lined keepsake box.',
  images: [
    '/photos/33.jpeg',
    '/photos/34.jpeg',
    '/photos/35.jpeg',
  ...
  features: [
    'Premium Velvet Keepsake Box',
    'Handcrafted Soy Candle (Rose & Vanilla)',
    'Assorted Luxury Chocolates',
    'Personalized Brass Engraved Tag'
  ],
  relatedProducts: [
    { id: 2, title: 'Blush & Gold Birthday Hamper', price: '₹3,299', image: '/photos/36.jpeg' },
    { id: 3, title: 'Elegant Floral Box', price: '₹3,499', image: '/photos/37.jpeg' },
    { id: 4, title: 'Minimalist Gift Box', price: '₹1,499', image: '/photos/38.jpeg' },
  ]
};
    ...
    <div className="min-h-screen bg-background pt-24 pb-32">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
          ...
          <Link href="/categories/anniversary-hampers" className="hover:text-primary">Anniversary Hampers</Link>
          <ChevronRight className="w-4 h-4" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
              ...
              <button
                ...
                className={`relative w-24 h-24 rounded-2xl overflow-hidden flex-shrink-0 border-2 bg-muted flex items-center justify-center transition-all ${showVideo ? 'border-primary ring-2 ring-primary/20' : 'border-transparent hover:border-border'}`}
              >
          ...
          <div className="flex flex-col">
            ...
            {/* Features */}
            <div className="mb-10">
              <h3 className="font-heading font-semibold text-xl mb-4">What's inside?</h3>
        ...
        <div className="fixed bottom-0 left-0 w-full bg-background/90 backdrop-blur-xl border-t border-border p-4 z-40 lg:hidden flex gap-4">
          <button className="flex-1 h-14 rounded-full bg-primary text-primary-foreground font-medium flex items-center justify-center gap-2 shadow-lg shadow-primary/20">
        ...
        <div className="hidden lg:flex fixed bottom-8 left-1/2 -translate-x-1/2 bg-background/95 backdrop-blur-xl border border-border shadow-2xl rounded-full p-2 z-40 items-center gap-4 min-w-[500px]">
          <div className="flex-1 px-6 font-semibold flex flex-col">
            <span className="text-xs text-muted-foreground font-medium uppercase tracking-wider">{productData.title}</span>
          ...
          <div className="flex items-center gap-4 pr-2">
            ...
            <button className="h-12 px-8 rounded-full bg-primary text-primary-foreground font-medium flex items-center justify-center gap-2 shadow-lg shadow-primary/20 hover:scale-105 transition-all">
